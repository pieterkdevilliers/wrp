    ...
    <section class="situation-section">
      <div class="section-inner">
        <div class="section-heading">
          <p class="section-eyebrow">Is This You?</p>
          <h2>On paper, everything looks fine.</h2>
        </div>
        <div class="for-body">
        ...
        <div class="steps">
          <div class="step">
            ...
            <div class="step-content">
              <h3>Diagnosis before prescription</h3>
              <p>We never recommend a solution until we understand the problem. What we find in the first thirty days shapes everything that follows.</p>
            </div>
          </div>
          <div class="step">
          ...
          <div class="step">
            ...
            <div class="step-content">
              <h3>Systems over heroics</h3>
              <p>Every problem that depends on the right person being available is a problem waiting to happen again. We replace heroics with documented, repeatable systems.</p>
            </div>
          </div>
          <div class="step">
            <span class="step-number">5</span>
            <div class="step-content">
              <h3>Progress must be visible</h3>
              <p>Vague improvement is not enough. At every stage you will be able to point to something specific that changed. Visible progress builds momentum.</p>
            </div>
          </div>
          <div class="step">
    ...
    <section class="process-section">
      <div class="section-inner">
        ...
        <div class="phase-header">
          ...
          <p class="phase-title">See It Clearly <span class="phase-meta">Weeks 1–4</span></p>
        </div>
        <div class="steps">
          <div class="step">
            <span class="step-number">1</span>
        ...
        <div class="phase-header">
          ...
          <p class="phase-title">Map It Properly <span class="phase-meta">Weeks 5–6</span></p>
        </div>
        <div class="steps">
          <div class="step">
            <span class="step-number">5</span>
        ...
        <div class="phase-header">
          ...
          <p class="phase-title">Fix It Systematically <span class="phase-meta">Months 2–6</span></p>
        </div>
        <div class="steps">
          <div class="step">
            <span class="step-number">6</span>
          ...
          <div class="step">
            ...
            <div class="step-content">
              ...
              <p>Every week, you send a short voice note or text. You receive a response within 24 hours. You are never more than a few days from a useful perspective on whatever you're dealing with.</p>
            </div>
          </div>
          <div class="step">
            <span class="step-number">9</span>
            <div class="step-content">
              <h3>The Living Business Journey Map</h3>
              <p>The journey map from the White Room day is updated monthly as systems are built and the business evolves. By the end of six months it is a complete record of the transformation.</p>
            </div>
          </div>
          <div class="step">
            <span class="step-number">10</span>
            <div class="step-content">
              <h3>The 90-Day Progress Assessment</h3>
              <p>At the 90-day mark, you retake the Value Leak Assessment. The before-and-after comparison shows precisely what has improved and what to prioritise in the second half of the programme.</p>
            </div>
          </div>
        </div>
        ...
        <div class="phase-header">
          ...
          <p class="phase-title">Make It Stick <span class="phase-meta">Month 6</span></p>
        </div>
        <div class="steps">
          <div class="step">
          ...
          <div class="step">
            ...
            <div class="step-content">
              <h3>The Documented Operations Pack</h3>
              <p>The ten to fifteen processes that matter most, documented so that anyone on your team can follow them without asking the founder how.</p>
            </div>
          </div>
        </div>
    ...
    <section class="inclusions-section">
      <div class="section-inner">
        <div class="section-heading">
          ...
          <h2>Nothing left out.</h2>
        </div>
        <div class="inclusions-grid">
          <div class="inclusion-group">
            <p class="inclusion-group-title">Diagnostic Tools</p>
            <ul class="inclusion-list">
              <li>Business Blindspot Report</li>
              <li>Value Leak Assessment (initial + 90-day rerun)</li>
              <li>90-minute Audit Call</li>
              <li>Written Audit Report with prioritised action plan</li>
              <li>Audit Report Review Call</li>
            </ul>
          </div>
          <div class="inclusion-group">
            <p class="inclusion-group-title">Intensive Mapping</p>
            <ul class="inclusion-list">
              <li>Full-day White Room Process Workshop (in person)</li>
          ...
          <div class="inclusion-group">
            <p class="inclusion-group-title">Documentation</p>
            <ul class="inclusion-list">
              <li>Written Audit Report</li>
              <li>Customer Journey Map</li>
              <li>Documented Operations Pack (10–15 key processes)</li>
      ...
      <div class="section-inner pricing-inner">
        ...
        <div class="pricing-card">
          ...
          <div class="pricing-card-row">
            <span class="detail-label">Audit Call + Written Report</span>
            <span class="detail-value">£249</span>
          </div>
          <div class="pricing-card-row">
            <span class="detail-label">White Room Process Workshop</span>
            <span class="detail-value">£2,495</span>
          </div>
          <div class="pricing-card-row">
            <span class="detail-label">5 × Monthly Strategy Calls</span>
          ...
          <div class="pricing-card-row">
            <span class="detail-label">Weekly Async Support (20 weeks)</span>
            <span class="detail-value">£600</span>
          </div>
          <div class="pricing-card-row">
            <span class="detail-label">Documented Operations Pack</span>
            <span class="detail-value">£800</span>
          </div>
          <div class="pricing-card-row">
            <span class="detail-label">Journey Map + Assessment access</span>
            <span class="detail-value">Included</span>
          </div>
          <div class="pricing-card-row pricing-card-subtotal">
            <span class="detail-label">Total component value</span>
            <span class="detail-value">£8,144</span>
          </div>
          <div class="pricing-card-row">
            <span class="detail-label">Programme price</span>
            <span class="detail-value price">£6,995</span>
          </div>
        </div>
      </div>
    </section>
...
.situation-body p + p { margin-top: 1.1rem; }
...
/* ─── STEPS (shared by principles + process) ─── */
.steps {
  display: flex;
  flex-direction: column;
  gap: 0;
...
.step-content p + p { margin-top: 0.85rem; }
...
/* Remove duplicate top border — phase-header already separates phases */
.phase-header + .steps .step:first-child { border-top: none; }
...
.after-body p + p { margin-top: 1.1rem; }
...
@media (max-width: 900px) {
  .cp-hero { padding: 8rem 1.5rem 5rem; }
  .situation-section { padding: 5rem 1.5rem; }
  .principles-section { padding: 5rem 1.5rem; }
  .process-section { padding: 5rem 1.5rem; }
  .inclusions-section { padding: 5rem 1.5rem; }
  ...
  .not-section { padding: 5rem 1.5rem; }
  .after-section { padding: 5rem 1.5rem; }
