    ...
    <section class="workshop-hero">
      <div class="workshop-hero-inner">
        ...
        <div class="hero-actions">
          <a href="https://api.blindspotworks.com/widget/bookings/wrp-interest-lets-talk" class="btn-primary" target="_blank" rel="noopener">Let's Talk</a>
        </div>
      </div>
    </section>
        ...
        <div class="workshop-inner">
          ...
          <div>
            <div class="workshop-details">
              ...
              <a href="https://api.blindspotworks.com/widget/bookings/wrp-interest-lets-talk" class="btn-primary workshop-cta" target="_blank" rel="noopener">Let's Talk</a>
            </div>
          </div>
        </div>
...
@media (max-width: 900px) {
  .workshop-hero { padding: 8rem 1.5rem 5rem; }
  .workshop-detail { padding: 5rem 1.5rem; }
